...
def edit_user(request, pk):
    ...
    ProfileInlineFormset = inlineformset_factory(User, UserProfile, fields=('bio', 'phone', 'city', 'country', 'organization'))
            ...
            if user_form.is_valid():
                ...
                if formset.is_valid():
                    ...
                    if request.user.is_superuser == False :
                        return HttpResponseRedirect('/extra/choice/')
                    else :
                        return HttpResponseRedirect('/physio/')
...
def edit_kine(request, pk):
    ...
    # The sorcery begins from here, see explanation below
    ProfileInlineFormset = inlineformset_factory(User, KineProfile, fields=('Establishment', 'Occupation'))
    formset = ProfileInlineFormset(instance=user)
            ...
            if user_form.is_valid():
                ...
                if formset.is_valid():
                    ...
                    if request.user.is_superuser == False :
                        ...
                        return HttpResponseRedirect('/kine/info/')
